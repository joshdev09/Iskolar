  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <footer className="mt-auto p-4">
        <p className="font-inter font-normal text-sm text-[#333333]">Made by @joshdev09</p>
      </footer>
    </div>
  );
}
    ...
    <div className="flex flex-col h-screen">
      ...
      <header className="flex items-center gap-3 px-4 py-3 bg-[#F7F8F0] shrink-0">
        ...
        <div className="flex w-full justify-end">
          <button className="p-2 w-25 bg-[#E8F5BD] cursor-pointer hover:bg-[#C7EABB] rounded-full font-normal text-sm">
            Signup
          </button>
        </div>
      </header>
      ...
      {/* SLIDE-IN DRAWER */}
      <aside
        className={`fixed top-0 left-0 z-50 h-full w-70 bg-[#F7F8F0] shadow-2xl transform transition-transform duration-300 ease-in-out ${
